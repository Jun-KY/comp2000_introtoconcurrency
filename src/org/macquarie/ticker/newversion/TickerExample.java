/*
 * Project: 	Stock ticker example.
 * File:		Sample application which uses the ticker.
 *
...
/**
 * An example application which uses our stock ticker. We create a MarketFeed and
 * a StockTicker widget object and set them both running in threads of their own.
 * Notice that we use different thread creation methodologies in each case - as 
 * described in the week 8 notes.
 * 
 * @author dom
 *
 */
...
public class TickerExample extends JFrame {
	...
	/**
	 * Our application must have an application object of type TickerExample, 
	...
	/**
	 * Our GUI contains only a single component, a StockTicker widget which is
	 * referred to by the following variable.
	 */
	private StockTicker mStockTicker = null;
	
	/**
	 * We also need a variable to hold the MarketFeed object we'll use to provide 
	 ...
	 * and to do that we use the SwingUtilities.invokeLater() method - you'll find
	 * out more about this in week 8.
	 * 
	 * @param args
	 */
