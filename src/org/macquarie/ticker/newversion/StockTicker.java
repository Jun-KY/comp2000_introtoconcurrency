 ...
 * File:		The ticker widget class itself.
 *
...
/**
 * The StockTicker widget class itself. This inherits from JTextField, because it really
 * is a special type of text field which automatically updates itself.
 * 
 * It also implements the Runnable interface, so that we can run it in a thread which keep
 * the ticker message moving. Look in the TickerExample class to see how we set this going
