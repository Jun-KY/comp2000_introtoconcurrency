/**
 * This file is part of a project entitled Wk8ProducerConsumer which is provided
 ...
 * 
 * Wk8ProducerConsumer is free software: you can redistribute it and/or modify
 * it under the terms of the GNU Lesser General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or (at your
 * option) any later version.
 * 
 * Wk8ProducerConsumer is distributed in the hope that it will be useful, but
 * WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or
 * FITNESS FOR A PARTICULAR PURPOSE. See the GNU Lesser General Public License
 * for more details.
 * 
 * You should have received a copy of the GNU Lesser General Public License
 * along with Wk8ProducerConsumer. (See files COPYING and COPYING.LESSER.) If
...
public class BoundedBuffer {
	...
	public synchronized void put(int pValue) throws InterruptedException {
		...
		// Finally notify a waiting thread that it may proceed.
		notify();
	}
	...
	public synchronized int get() throws InterruptedException {
		...
		// Notify a waiting thread that it may proceed.
		notify();
